<template>
  <div v-if="!deleted" class="min-w-64 p-4 rounded-lg shadow-lg " :class="finished ? 'bg-blue-200' : 'bg-gray-300' ">
    <div v-if="!finished">
      ...
      <div>
        <label for="arrival_time" class="block mb-2 text-sm font-medium text-gray-900">Arrival Time:</label>
        <input 
          type="number" 
          name="arrival_time" 
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" 
      ...
      <div>
        <label for="burst_time" class="block mb-2 text-sm font-medium text-gray-900">Burst Time:</label>
        <input 
          type="number" 
          name="burst_time" 
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" 
